import { Scene, Object3D, AmbientLight, DirectionalLight, Clock, AnimationMixer, AnimationAction, } from 'three';
...
export default class MainMenuScene extends Scene {
    ...
    async load() {
        ...
        // animate player
        const dancingAnimationObject = await this.fbxLoader.loadAsync('../../assets/animations/dancing.fbx');
